...
//!   closing it cannot stall the message loop that services the hook.
...
/// Whether a window is alive. Guards against a second one and tells `emit`
...
/// A second click while one is open is ignored — the existing window already
/// shows everything.
pub fn open() {
...
impl eframe::App for LogApp {
    fn ui(&mut self, ui: &mut egui::Ui, _frame: &mut eframe::Frame) {
        ...
        // for input events; idle cost is one cheap frame every 200 ms.
