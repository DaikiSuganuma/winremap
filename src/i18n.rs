...
pub struct Texts {
    ...
    pub config_ime_change_cursor_color: &'static str,
    pub config_ime_cursor_color: &'static str,
    pub config_ime_cursor_color_hint: &'static str,
...
static EN: Texts = Texts {
    ...
    config_ime_change_cursor_color: "Tint the mouse cursor",
    config_ime_cursor_color: "Cursor colour",
    config_ime_cursor_color_hint: "write it as #rrggbb",
...
static JA: Texts = Texts {
    ...
    config_ime_change_cursor_color: "マウスカーソルに色を付ける",
    config_ime_cursor_color: "カーソルの色",
    config_ime_cursor_color_hint: "「#rrggbb」の形で書いてください",
