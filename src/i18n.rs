...
pub struct Texts {
    ...
    pub config_macro_delay_hint: &'static str,
...
static EN: Texts = Texts {
    ...
    config_macro_delay_hint: "Pause between the strokes of a macro. Raise it for apps that drop burst-injected input (e.g. the WinUI Notepad); 0-15.",
...
static JA: Texts = Texts {
    ...
    config_rules: "リマップ規則",
    config_rule_input: "入力",
    config_rule_output: "出力",
    ...
    config_macro_delay_hint: "マクロの各打鍵の間隔です。一括入力を取りこぼすアプリ（WinUI 版メモ帳など）では大きくしてください。0〜15。",
