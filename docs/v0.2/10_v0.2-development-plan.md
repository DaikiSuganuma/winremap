...
> 元資料: [01_project-brief.md](../01_project-brief.md) §3.2（v0.2 候補）、[02_development-plan.md](../v0.1/02_development-plan.md) Phase 5。
...
6. v0.2 用の受け入れチェックリストを `docs/v0.2/` に作成し（v0.1 の [05_acceptance-checklist.md](../v0.1/05_acceptance-checklist.md) を基に）、確認項目を追加
...
2. `docs/v0.2/11_config-gui-design.md` — 画面設計・編集モデルの設計書
