...
**2026-09-14、オーナーが §2 の提出物を Partner Center へ提出した。2026-09-15、認定を通ったとオーナーから連絡があった。**
...
**2026-09-15 実施:** 開発者登録した 1.0.1 の設定を `C:\Users\suganuma\winremap-dev-1.0.1-backup-20260915` へ退避して削除し、オーナーが Store からインストールした。P-8 は通過（[受け入れ §5](../03_acceptance-checklist.md)）。この機械には Store 版 1.0.1 が入っている。
