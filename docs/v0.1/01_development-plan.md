...
>
> 2026-07-19: オーナー指示により、IME 状態インジケーターの統合を決定（ADR 0020）。設計・計画は [08_ime-indicator-design.md](./05_ime-indicator-design.md) / [09_ime-indicator-plan.md](./06_ime-indicator-plan.md) に分離して管理する。
