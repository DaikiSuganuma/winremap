...
| [v0.4/](v0.4/) | v0.4 開発計画（[01_development-plan.md](v0.4/01_development-plan.md)）。decisions/（ADR 0049-）。スコープは設定 GUI 編集（B2〜B5）・ログへの入力/制御文字コード表示・README/ヘルプサイト反映。設定 GUI の設計は [v0.2/04_config-gui-design.md](v0.2/04_config-gui-design.md) を継続使用 |
