...
| [v0.2/](v0.2/) | v0.2 開発計画（[01_development-plan.md](v0.2/01_development-plan.md)）、GUI フレームワーク比較調査（[02_gui-framework-study.md](v0.2/02_gui-framework-study.md)）、decisions/（ADR 0029-0030） |
