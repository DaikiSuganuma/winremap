...
| [v0.6/](v0.6/) | v0.6 開発計画（[01_development-plan.md](v0.6/01_development-plan.md)）、受け入れチェックリスト（[03_acceptance-checklist.md](v0.6/03_acceptance-checklist.md)）、decisions/（ADR 0059-0061）、notes/（[ストア掲載情報の草案](v0.6/notes/20260729_store-listing.md)）。スコープは Microsoft Store（MSIX）対応 — SmartScreen の警告を消せる唯一の配信経路だという調査結果に基づく |
