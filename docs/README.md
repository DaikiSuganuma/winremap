...
| [v0.8/](v0.8/) | **開発中（実装完了・受け入れ待ち）。** v0.8 開発計画（[01_development-plan.md](v0.8/01_development-plan.md)）、受け入れチェックリスト（[03_acceptance-checklist.md](v0.8/03_acceptance-checklist.md)）、decisions/（ADR 0066-0072）。スコープはヘルプサイトの Zola 化・IME の状態をマウスカーソルの色で示す・`--debug` の `AllocConsole` 化・受け入れテストの対話化 |
