...
| [v0.8/](v0.8/) | **計画中。** v0.8 開発計画（[01_development-plan.md](v0.8/01_development-plan.md)）、decisions/（ADR 0066-）。スコープはヘルプサイトの Zola 化・IME の状態をマウスカーソルの色で示す・`--debug` の `AllocConsole` 化・受け入れテストの対話化 |
