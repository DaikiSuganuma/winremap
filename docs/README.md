...
| [v0.7/](v0.7/) | **開発中。** v0.7 開発計画（[01_development-plan.md](v0.7/01_development-plan.md)）、decisions/（ADR 0063-）、notes/（[キーボード配列の実測](v0.7/notes/20260731_layout-probe.md)）。スコープは記号（OEM）キー対応と、UI テストの操作系の winapp CLI への移行 |
