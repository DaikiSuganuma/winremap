...
| [v0.3/](v0.3/) | v0.3 開発計画（[01_development-plan.md](v0.3/01_development-plan.md)）、マクロ記憶機能設計書（[02_macro-record-design.md](v0.3/02_macro-record-design.md)）、受け入れチェックリスト（[03_acceptance-checklist.md](v0.3/03_acceptance-checklist.md)）、decisions/（ADR 0043-）。スコープはマクロ記憶機能・winget/scoop 対応・README/ヘルプサイト反映 |
