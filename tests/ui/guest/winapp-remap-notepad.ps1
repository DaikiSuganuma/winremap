# Runs inside the guest, in session 1. Scenario 05-remap-notepad with the agent
...
#
# Host side: .\run-vm-ui-test.ps1 -Scenario 05-remap-winapp

$ErrorActionPreference = "Continue"
$exe = "C:\Test\winremap.exe"
$outPath = "C:\Test\winapp-remap-notepad.txt"
